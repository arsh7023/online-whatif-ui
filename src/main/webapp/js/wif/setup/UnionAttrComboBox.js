Ext.define('Wif.setup.UnionAttrComboBox', {
  ...
  constructor : function(config) {
    ...
    if (config.projectId) {
      this.serviceParams.url = Wif.endpoint + 'projects/' + config.projectId + '/unionAttributes/';
    }
  ...
  load : function(projectId, loadcallback) {
    ...
    if (projectId) {
      this.serviceParams.url = Wif.endpoint + 'projects/' + projectId + '/unionAttributes/';
    }
