Ext.define('Wif.setup.demandnew.demandnewEnumPopulCard', {
...
//	  }
	  /*
	  if (cbox.name == 'LandUseFeatureFieldName')
	  {
	      cbox.setValue(definition.LandUseFeatureFieldName);
	  }*/
